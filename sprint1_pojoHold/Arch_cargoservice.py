...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     cargoservice >> Edge(color='magenta', style='solid', decorate='true', label='<moverobotinternal<font color="darkgreen"> moverobotinternaldone moverobotinternalfailed</font> &nbsp; >',  fontcolor='magenta') >> cargorobot
