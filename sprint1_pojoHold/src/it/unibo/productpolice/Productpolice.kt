		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t005",targetState="waitsendQuery",cond=whenRequest("productrequest"))
				}	 
				state("waitsendQuery") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t16",targetState="receiveparseanswer",cond=whenReply("getProductAnswer"))
				}	 
