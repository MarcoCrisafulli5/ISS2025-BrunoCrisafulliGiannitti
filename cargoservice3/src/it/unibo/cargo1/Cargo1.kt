		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t000",targetState="s1",cond=whenRequest("requesttoload"))
				}	 
				state("s1") { //this:State
					action { //it:State
						answer("requesttoload", "replyrequesttoload", "replyrequesttoload(X)"   )  
						...
						delay(5000) 
						request("productrequest", "productrequest(1)" ,"productservice" )  
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
					}	 	 
					 transition(edgeName="t01",targetState="s2",cond=whenReply("onlinereply"))
					transition(edgeName="t02",targetState="work",cond=whenDispatch("msg1"))
					transition(edgeName="t03",targetState="perceiver",cond=whenEvent("sonardata"))
				}	 
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t14",targetState="handleReply",cond=whenReply("holdreply"))
					transition(edgeName="t15",targetState="handleReply",cond=whenReply("holdreplyfailed"))
				}	 
