...
class Cargohold ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="s1",cond=whenRequest("isonline"))
				}	 
				state("s1") { //this:State
					action { //it:State
				...
				state("work") { //this:State
					action { //it:State
						...
						forward("msg1", "msg1(1)" ,"cargo1" ) 
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
					}	 	 
					 transition(edgeName="t17",targetState="handleRequest",cond=whenRequest("holdrequest"))
				}	 
