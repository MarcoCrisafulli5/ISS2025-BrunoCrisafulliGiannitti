	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("ready") { //this:State
					...
					transition(edgeName="t023",targetState="handleRelease",cond=whenDispatch("slotrelease"))
				}	 
				state("handleHoldReq") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t124",targetState="invalidPayload",cond=whenDispatchGuarded("msg1",{ invalid  
					}))
					transition(edgeName="t125",targetState="overweight",cond=whenDispatchGuarded("msg1",{ overweight  
					}))
					transition(edgeName="t126",targetState="full",cond=whenDispatchGuarded("msg1",{ full  
					}))
					transition(edgeName="t127",targetState="reserve",cond=whenDispatchGuarded("msg1",{ !invalid && !overweight && !full  
					}))
				}	 
				...
				state("handleRelease") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("slotrelease(SLOT)"), Term.createTerm("slotrelease(SLOT)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
